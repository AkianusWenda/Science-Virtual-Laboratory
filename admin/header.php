...
<head>
  ...
  <title>Dysmenorrheainsights</title>
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
          ...
          ?> <li class="menu-item">
              ...
              <li class="menu-item">
                <a href="videodaftar.php" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-layout"></i>
                  <div data-i18n="Basic">Kuis</div>
                </a>
              </li>
              <li class="menu-item">
              ...
              <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                  <div class="avatar avatar-online">
                    <img src="assets/admin/assets/img/adm.png" alt class="w-px-40 h-auto rounded-circle" />
                  </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="#">
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1">
                          <span class="fw-semibold d-block"><?= $_SESSION["pengguna"]['nama'] ?></span>
                        </div>
                      </div>
                    </a>
                  </li>
                  ...
                  <li>
                    <a class="dropdown-item" href="logout.php" onclick="return confirm('Apakah Anda Yakin Mau Keluar?')">
