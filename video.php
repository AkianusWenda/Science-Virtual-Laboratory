        ...
        <div class="container">
            ...
            <nav class="breadcrumbs">
                <ol>
                    ...
                    <li class="current">Daftar Video</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                ?>
                        <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                            <div class="post-box">
                                ...
                                <a href="videodetail.php?id=<?php echo $video['idvideo']; ?>" class="readmore stretched-link"><span>Lihat Video</span><i class="bi bi-arrow-right"></i></a>
                            </div>
                        </div>
                    <?php
                    endwhile;
                    ...
                    ?>
                    <div class="col-12">
                        <p class="alert alert-warning">Belum ada video yang tersedia.</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
